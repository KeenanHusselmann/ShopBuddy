-- Corrected Customer Account Check
...
-- Check what columns actually exist in auth.users for this email
SELECT 
    'Auth User Columns' as check_type,
    'Available columns in auth.users table:' as note;
