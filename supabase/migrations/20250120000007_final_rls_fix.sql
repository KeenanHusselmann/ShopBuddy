...
-- This migration properly handles existing policies and ensures clean RLS setup

-- First, disable RLS temporarily to clear all policies
ALTER TABLE public.profiles DISABLE ROW LEVEL SECURITY;

-- Drop ALL existing policies on the profiles table (using IF EXISTS to avoid errors)
